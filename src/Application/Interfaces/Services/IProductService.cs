...
{
    Task<LaravelApiResponse> GetSegmentsAsync(string? search, bool includeInactive, int? page, int? pageSize, CancellationToken cancellationToken);
    ...
    Task<LaravelApiResponse> GetFamiliesAsync(ulong? segmentId, string? search, bool includeInactive, int? page, int? pageSize, CancellationToken cancellationToken);
    ...
    Task<LaravelApiResponse> GetProductsAsync(ulong? segmentId, ulong? familyId, string? search, bool includeInactive, int? page, int? pageSize, CancellationToken cancellationToken);
